...
- **npm 0.1.2-rc.1** — प्लगइन `@deepseek-ai/dsh@0.1.2-rc.1` के विरुद्ध विकसित और परीक्षित है; नए हार्नेस बेसलाइन काम करने चाहिए और मासिक compat वर्कफ़्लो उन्हें सत्यापित करता है।
