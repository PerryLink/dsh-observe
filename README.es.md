...
- **Solo rc.6** — el plugin se desarrolla y prueba contra `@deepseek-ai/dsh@0.1.0-rc.6`; se espera que baselines más nuevos funcionen y el workflow compat mensual los verifica.
...
pnpm test           # vitest: 95 tests, 13 suites (Context/Session/storage seam reales)
