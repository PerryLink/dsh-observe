...
- **Solo rc.2** — el plugin se desarrolla y prueba contra `@deepseek-ai/dsh@0.1.1-rc.2`; se espera que baselines más nuevos funcionen y el workflow compat mensual los verifica.
