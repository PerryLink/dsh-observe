#!/usr/bin/env node
/**
 * Print one version's CHANGELOG section to stdout (heading included,
 * everything until the next `## [` heading). Used by the release workflow to
 * build the GitHub Release body and easy to reuse for backfilled release
 * notes.
 *
 * Usage: node scripts/changelog-section.mjs <version>
 *
 * @module dsh-observe/scripts/changelog-section
 */
...
// Section headings carry a date suffix (`## [0.1.0] - 2026-08-16`); the
