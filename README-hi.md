...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.6-alpha.2` (2026-09-18 को अनुकूलित): सत्र प्रारूप V3 सहायक स्ट्रीम को `assistant/message` / `assistant/attempt` में एम्बेड करता है और सिस्टम प्रॉम्प्ट को सरफ़ेस नोड 0 (`system/message`) के रूप में रखता है; प्लगइन केवल लाइव इवेंट स्ट्रीम पढ़ता है और कभी सत्र लॉग फ़ाइलें नहीं पढ़ता। peer रेंज `>=0.1.2-rc.1 <0.2.0 \|\| >=0.1.5-alpha.1 <0.2.0 \|\| >=0.1.6-0 <0.2.0` हर प्रकाशित लाइन को इंस्टॉल-योग्य रखती है (स्थानीय पूर्ण गेट श्रृंखला; प्रोफ़ाइल इंस्टॉल स्मोक compat वर्कफ़्लो कवर करता है)। |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
- **npm 0.1.6-alpha.2** — प्लगइन `@deepseek-ai/dsh@0.1.6-alpha.2` के विरुद्ध विकसित और परीक्षित है (devDeps और CI की मुख्य रूलर); peer रेंज `>=0.1.2-rc.1 <0.2.0 || >=0.1.5-alpha.1 <0.2.0 || >=0.1.6-0 <0.2.0` हर प्रकाशित लाइन को इंस्टॉल-योग्य रखती है, और दूसरी रूलर (`typecheck:ci`) तथा compat वर्कफ़्लो पुराने बेसलाइन कवर करते हैं।
...
pnpm run typecheck  # tsc: src + tests 0.1.6-alpha.2 devDeps के विरुद्ध (कोई tsconfig paths नहीं)
